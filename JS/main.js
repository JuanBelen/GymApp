...
clearAllBtn.addEventListener("click", () => {
  openConfirm("¿Seguro que querés borrar TODOS los registros?", () => {
    saveEntries([]);  // limpiamos usando el módulo
    resetEditMode();
    renderEntries();
    renderSummary("week");
    updateStreakBanner();
...
// Export / Import usando el módulo
exportBtn.addEventListener("click", () => {
  const data = exportAll(profile);
